...
<ins>We would like to make the files on Google Drive available to the public with no delay, but we haven't figured out a way to bypass the permission system of Google Drive. Please give us up to a few days to process your request. We aim to process the request in the same day. </ins>
